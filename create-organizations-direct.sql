-- Create Organizations Directly (Alternative Method)
-- This script creates organization accounts directly in the database
-- Use this if you want to skip the manual registration step

-- IMPORTANT: This method bypasses Supabase Auth, so these accounts won't be able to log in
-- They're useful for display purposes and linking events

-- Step 1: Insert organization profiles directly
...
SELECT 'Organizations created directly and events linked successfully!' as status;
