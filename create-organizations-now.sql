-- Create Organizations Right Now (Working Solution)
-- This script creates organization profiles directly and links events
-- No need to create user accounts first - these will show up immediately
...
-- Step 4: Check organizations count
SELECT COUNT(*) as organization_count FROM profiles WHERE user_type = 'organization';

SELECT 'Organizations created and events linked successfully! Check the organizations page now.' as status;
